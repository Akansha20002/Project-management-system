...
namespace OrganizationManagement.Controllers
{
    public class AccountController : Controller
    {
        ...
        public IActionResult Login()
        {
            // If cookies already exist, redirect to dashboard
        ...
        {
            var org = await _tables.Organizations.FindAsync(id);
            if (org != null)
            {
                _tables.Organizations.Remove(org);
                await _tables.SaveChangesAsync();
            }
